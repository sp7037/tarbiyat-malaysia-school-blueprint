...
| [ADR-0004 — Student Development](/decisions/adr-0004) | 1.0.0 | `APPROVED` |
| [ADR-0005 — Stage Boundaries & Major-Minor Entry](/decisions/adr-0005) | 1.0.0 | `APPROVED` (GAP-003/004/021 Closed) |
| [ADR-0006 — Transition / Exploration Floor / Mobility](/decisions/adr-0006) | 1.0.0 | `APPROVED` (GAP-019/020 Closed) |
...
|---|---|---|
| Six Worlds competency maps | Architecture APPROVED in ADR-0011 (GAP-008 Closed); Discover exposure APPROVED in ADR-0017; Discover→Choose preparation APPROVED in ADR-0018; Graph/tagging remain | [GAP-008](/gaps#gap-008), [ADR-0011](/decisions/adr-0011), [ADR-0017](/decisions/adr-0017), [ADR-0018](/decisions/adr-0018), [GAP-009](/gaps#gap-009), [GAP-047](/gaps#gap-047) |
...
| Faculty staffing / Mission capacity / Mentor caseload / country role mapping | ADR-0015 APPROVED; PEO-001 / PEO-002 / PEO-003 APPROVED (GAP-033 / 035 / 036 Closed); MY-002 APPROVED (GAP-037 Partially resolved — not closed); PEO-004–005 remain DRAFT (GAP-032 / 034 not closed) | [GAP-032](/gaps#gap-032)–[GAP-037](/gaps#gap-037), [ADR-0015](/decisions/adr-0015), [PEO-001](/areas/practitioner-authorisation)–[PEO-005](/areas/mentor-caseload-capacity), [MY-002](/country/malaysia-regulated-people) |
