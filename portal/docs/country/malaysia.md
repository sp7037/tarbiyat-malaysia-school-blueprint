...
Concept Note “government-owned” language is a **proposal**, not current Country Path authority.
:::

## Current documentation status

| Document | Status | Portal view |
|---|---|---|
...
- [GAP-001](/gaps#gap-001) — Licensing / establishment pathway — **Partial** via [MY-003](/country/malaysia-school-path) (category not selected)
- [GAP-002](/gaps#gap-002) — National/board exam mapping — **Partial** via [MY-003](/country/malaysia-school-path) (package not selected)
