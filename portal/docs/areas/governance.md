...
- [GAP-032](/gaps#gap-032)–[GAP-037](/gaps#gap-037) — Faculty staffing / authorisation / country role mapping (opened by ADR-0015); [GAP-033](/gaps#gap-033) via [PEO-001](/areas/practitioner-authorisation); [GAP-035](/gaps#gap-035) via [PEO-002](/areas/practitioner-currency) — proposed, not closed
