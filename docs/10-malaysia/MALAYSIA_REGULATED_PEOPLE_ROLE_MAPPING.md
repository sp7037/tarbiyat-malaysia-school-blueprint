# Malaysia Regulated People / Faculty Role Mapping
...
| Dependencies | `ADR-0001` APPROVED; `FND-003` APPROVED; `ADR-0015` APPROVED; `PEO-001` APPROVED (GAP-033 Closed); `PEO-002` APPROVED (GAP-035 Closed); `PEO-003`–`PEO-005` DRAFT; `MIS-001`–`003` APPROVED; `MY-000` / `MY-001`; Country Path research `MY-003` DRAFT |
