...
Operational tracker: `GAP_REGISTER.md`. This file holds longer research notes.

## Priority research packages

### RP-A — Malaysia recognition & regulation
...
- Human designation of which Oman version is historical reference baseline.
- Explicit discard list for Malaysia (boarding, sovereign DC, partners, etc.).

### RP-E — Claims audit

- Every uniqueness claim in conceptual-evolution and country notes either evidenced or retired.

### RP-F — Faculty / workforce architecture (opened with ADR-0015)
...
- **Status (2026-09-16):** Malaysia mapping lodged as `MY-002` DRAFT (`v0.1.1` category overlays after `MY-003`); `GAP-037` proposed via MY-002 — **not closed**. ADR-0015 / PEO-001–005 remain unapproved; GAP-032–036 unchanged; campus category still unset.
...
- **Status (2026-09-16 Country Path):** `MY-003` supplies DRAFT research input for IMP-001 Gate B Country Path Brief / Hard-Blocker classes. Category choice and licences remain Hard Blockers; IMP-001 architecture unchanged.
