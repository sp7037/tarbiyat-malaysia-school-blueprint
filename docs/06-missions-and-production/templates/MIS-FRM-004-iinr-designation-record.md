# MIS-FRM-004 — Institution / Industry-in-Residence Designation Record
...
|---|---|
| Organisation name | |
| Proposed subtype (Industry / University / Research / Public / Creative / Community / other) | |
| Date of application / review | |
| Record owner | |
| Reviewer(s) | |
| Review period end / next review | |

---

## Prerequisites (MIS-001 compliance)
...
| Learner access boundaries accepted | | ☐ |
| IP / data compliance | | ☐ |
...
| Outcome | Tick | Notes |
|---|---|---|
| **Institution / Industry-in-Residence** | ☐ | |
| **Mission Partner only** | ☐ | |
| **Visiting Expert only** | ☐ | |
| **Practitioner-in-Residence** (individual, not full organisational I-in-R) | ☐ | |
| **Deferred** | ☐ | |
| **Rejected** | ☐ | |
