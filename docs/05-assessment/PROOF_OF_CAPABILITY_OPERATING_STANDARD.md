...
| Dependencies | `FND-003` APPROVED; `ADR-0003` APPROVED; `ADR-0019` APPROVED; governing architecture `ADR-0016` APPROVED; contribution/sanitised-evidence context `ADR-0014` APPROVED; faculty multi-stream context `ADR-0015` APPROVED with `PEO-001` APPROVED (GAP-033 Closed) and `PEO-002` APPROVED (GAP-035 Closed); `PEO-003` APPROVED (GAP-036 Closed); `PEO-004`–`PEO-005` DRAFT; mission authenticity context `ADR-0007` APPROVED; `MIS-001`–`MIS-003` APPROVED |
