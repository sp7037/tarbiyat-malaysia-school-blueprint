...
| Dependencies | `FND-003` APPROVED; `ADR-0003` APPROVED; `ADR-0019` APPROVED; governing architecture `ADR-0016` APPROVED; contribution/sanitised-evidence context `ADR-0014` UNDER REVIEW; faculty multi-stream context `ADR-0015` UNDER REVIEW with `PEO-001`–`PEO-005` DRAFT; mission authenticity context `ADR-0007` UNDER REVIEW; `MIS-001`–`MIS-003` DRAFT |
