...
| Source documents | Ratification (2026-09-13); Iteration 2–13 ADR drafts; Integrated Developmental Architecture approvals; ADR-0007 APPROVED / GAP-018 Closed (2026-09-17) |
...
**ADR-0007** (`APPROVED` v1.0.0) defines governed Mission Ecosystem; Mission vs Activity/Project; authenticity levels A–F; Strategic Capability Missions; Institution-in-Residence; Education-First / no exploitation; Mission Educationalisation and lifecycle; Campus Live Workflow; Deployment Boundary. Depends on FND-003 / ADR-0001–0006 / 0011 / 0016 / 0019 / 0020 (APPROVED); uses ADR-0014 / 0015 as under-review context only. Does **not** invent Malaysian partnerships, IP ownership, PoC ops schemas or strategic-sector Core lists. **Closes `GAP-018`.** MIS-001–003 remain DRAFT (`GAP-022`–`024` not closed).
