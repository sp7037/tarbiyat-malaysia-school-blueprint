...
| Source documents | Ratification (2026-09-13); Iteration 2–13 ADR drafts (0004–0007, 0011, 0014–0020); Integrated Developmental Architecture approvals (2026-09-17) |
...
**ADR-0007** proposes governed Mission Ecosystem; Mission vs Activity/Project; authenticity levels A–F; Strategic Capability Missions; Institution-in-Residence; Education-First / no exploitation; Mission Educationalisation and lifecycle. Depends on ADR-0002 (APPROVED) and ADR-0004–0006 (APPROVED). Does **not** invent Malaysian partnerships, IP ownership, PoC schemas or strategic-sector Core lists. **Not APPROVED.** Proposed resolution of `GAP-018` — not closed.
