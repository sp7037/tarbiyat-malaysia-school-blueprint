# Faculty and Practitioner Development Standard
...
| Related gaps | GAP-036 (this document); GAP-033 (`PEO-001`); GAP-035 (`PEO-002`); GAP-037 (country CPD / registration — handoff); GAP-032 / 034 (not resolved here) |
...
`PEO-002` answers: **How do we know their authority remains current?**

This standard answers:

> How does Tarbiyat **deliberately develop** Educators, Practitioners, Mentors, Mission Leads, Technical / Lab Professionals and Faculty Practitioners so they can operate the Tarbiyat model effectively?

Prevents:

- assuming conventional professional competence automatically equals Tarbiyat operating competence;
...
This document proposes resolution of **GAP-036**. It is **not** an authorisation standard (`PEO-001`), currency review standard (`PEO-002`), staffing-ratio standard (`GAP-032`), Mentor caseload standard (`GAP-034`), or country registration map (`GAP-037`).

---

## 2. Core principle — deliberate adult development

Tarbiyat requires **deliberate adult development** because conventional professional competence alone does not automatically prepare someone to operate Tarbiyat.

Adults must be able to support, as relevant to their functions:
...
- pathway guidance;
- Mission teams;
- Industry / Institution-in-Residence;
- Campus Live Workflow;
- proportional safeguarding;
- capability evidence / PoC;
- Creator Rights;
- ethical human formation.

Development should be:

| Attribute | Meaning |
|---|---|
| **Role-relevant** | Matched to actual functions, not job-title theatre |
| **Function-specific** | Different functions need different depth |
| **Practice-based** | Learn by doing with observation and feedback |
| **Mission-connected** | Real Missions where appropriate, not slides alone |
| **Reflective** | Includes judgment and ethical formation |
| **Evidence-informed** | Observed practice and outcomes matter |
| **Ongoing** | Not a one-time induction event |
| **Proportional** | Guests and long-term faculty are not treated identically |

**Not everyone needs identical training.**

---

## 3. Development ≠ authorisation ≠ currency
...
```
PEO-001 Authorisation  ←→  PEO-003 Development  ←→  PEO-002 Currency
        (permission)            (capability)            (recency)
```

---

## 4. Functions (not rigid job-title silos)

Development needs are defined for **functions**. One person may develop across multiple functions. Avoid silos.

| Code | Function | Development focus (summary) |
|---|---|---|
| **A** | Educator | Disciplinary foundations + Lab/Mission-oriented teaching; production design; critique; Formal Recognition coexistence |
| **B** | Practitioner | Translate professional work into educational work; safe learner contact; critique without takeover |
| **C** | Mentor / Advisor | Developmental guidance; Discover→Choose; equal World dignity; wellbeing observation; human over algorithmic judgment |
| **D** | Mission Lead | Lifecycle, educationalisation, coordination, risk escalation, scope, Creator Rights triggers |
| **E** | Technical / Lab Professional | Safety, competence gates, stop-work, authentic production support without doing learner work |
| **F** | Faculty Practitioner (PA-4) | Bridge professional + educational practice; assessment literacy; Mission design |
| **G** | External Practitioner-in-Residence | Proportional Tarbiyat orientation; partner / embedding / risk boundaries |
...
## 5. Common Tarbiyat orientation (Layer 1)

All **regular** adults who work with learners or Missions should understand, at principle level:

- Tarbiyat purpose and Concept Constitution (FND-003);
- Education-First;
- Lab-First (not Lab-Only);
- Mission vs project/activity;
- Production over demonstration;
- Six Worlds and equal dignity;
- developmental stages (Explore → Discover → Choose → Deepen → Produce);
- learner dignity and agency;
- safeguarding and professional boundaries;
- human governance (AI/software assistance ≠ human authority);
- recognition / exam coexistence;
- ethical / character expectations for adults.

Keep this **principle-level orientation**, not a 100-page course. Depth varies by function and contact intensity. Occasional guest speakers may receive a lighter briefing rather than full Layer 1.

---

## 6. Educator development

Educators may need development in:

- disciplinary foundations for Lab/Mission use;
- concept teaching that enables production and inquiry;
- designing learning around authentic production (not demonstration-only);
- critique and feedback literacy;
- interdisciplinary collaboration with Practitioners and Technical Professionals;
- evidence interpretation (capability / PoC awareness);
- avoiding exam-only teaching while meeting Formal Recognition duties;
- supporting breadth + concentration (Exploration Floor / pathway coexistence).

**Do not turn Educator into Practitioner automatically.** Additional Practitioner functions require separate development and authorisation (`PEO-001`).

---

## 7. Practitioner development

Practitioners may need development in:

- translating professional work into educational work;
- Mission educationalisation (Education-First under partner pressure);
- working safely with minors;
- explaining professional standards accessibly;
...
## 8. Mentor / Advisor development

Mentors should understand:

- developmental guidance and learner reflection;
- Discover → Choose transition risks (premature locking, streaming);
...
## 9. Mission Lead development

Mission Leads should develop competence in:

- Mission lifecycle and brief discipline;
- educationalisation under Education-First;
- team and partner coordination;
- documentation (`MIS-TPL-001` literacy as needed);
- risk escalation (`MIS-003`);
- scope management and learner workload awareness;
- deployment handoffs;
...
## 10. Technical / Lab Professional development

Focus on:

- safety systems and facility / tool governance;
- learner competence gates before elevated tools;
- equipment supervision and stop-work authority;
- incident / near-miss learning;
- supporting authentic production **without doing the work for learners**.

Technical excellence alone does not replace safeguarding or educational boundary literacy where learner contact exists.

---

## 11. Faculty Practitioner development (PA-4)

PA-4 / Faculty Practitioner should bridge professional and educational practice. Possible areas:

- educational planning with Educators;
- learner development awareness;
- assessment literacy (what they may and may not decide);
- safeguarding;
- Mission design and educationalisation;
- sustained technical / professional practice;
...
## 12. I-in-R / external practitioner orientation

External embedded practitioners require **Tarbiyat orientation** even when professionally senior.

Include, proportionally to contact and risk:

- Education-First;
- `MIS-001` partner boundaries;
- `MIS-002` embedding rules;
- `MIS-003` risk / stop-work;
- learner contact and safeguarding expectations;
- IP / data / Creator Rights boundaries;
- assessment limits;
- political / commercial neutrality;
- escalation paths.
...
Allow multiple modes; avoid classroom-course-only development:

- induction / orientation;
- workshops;
- supervised practice;
- shadowing;
- co-teaching / co-facilitation;
- Mission participation;
- peer review / peer observation;
- coaching and mentoring;
- professional practice;
- external CPD;
- reflective review;
- simulations / case review;
- incident / near-miss learning.

---

## 14. Practice-based development progression

Tarbiyat adult development should mirror Tarbiyat learning philosophy. Adults should not learn Mission facilitation only from slides.

Where appropriate:

**Learn → Observe → Practise → Co-facilitate → Demonstrate → Receive feedback → Reflect → Independently perform when authorised**

Hard boundary: **training progression ≠ permission.** Independent performance requires authorisation (`PEO-001`) and remains subject to currency (`PEO-002`).
...
- reflection;
- peer feedback;
- learner-safe facilitation observation;
- portfolio;
...
## 16. Induction structure (avoid duplication)

Differentiate:

| Layer | Purpose | Typical vehicle |
|---|---|---|
| **A. Basic institutional orientation** | School conduct, safeguarding basics, Culture | All regular adults |
| **B. Function-specific induction** | Role-relevant Tarbiyat operating capability | This standard Layers 1–2 |
| **C. Mission-specific onboarding** | This Mission’s brief, risks, partners | Mission pack / FRM as needed |
| **D. Authorisation process** | Scoped permission decision | `PEO-001` / `MIS-FRM-007` |

Do not merge B into D. Do not replace `MIS-FRM-002` with a generic development form for external practitioners.

---

## 17. Development pathways (no automatic promotion)

Allow development from one function toward another, for example:

| From | Toward (illustrative) |
|---|---|
| Educator | Educator + Mission Lead |
| Practitioner | Practitioner + Faculty Practitioner (PA-4) |
...
## 21. Character / ethical formation

Adult development must include professional and ethical formation. Areas may include:

- responsibility and integrity;
- humility and service;
- fairness and learner dignity;
- craftsmanship and stewardship;
- professional boundaries;
- avoiding prestige behaviour;
- reflective practice.

Keep this **non-sectarian and non-ideological**. Formation supports Tarbiyat purpose; it does not impose a political or confessional programme.

---

## 22. AI / digital capability

Staff should understand responsible AI/software use appropriate to their function:
...
| Layer | Purpose |
|---|---|
| **1 — Tarbiyat Orientation** | Common principle-level understanding (§5) |
...
Development programme quality may consider:
...
## 30. Core vs country vs implementation
...
| GAP-032 / 034 | — | Ratios and Mentor caseloads |
...
- invent staffing ratios (`GAP-032`) or Mentor caseloads (`GAP-034`);
