...
| Source documents | Pre-flight inventory (2026-09-13) |
...
| FND-003 | `docs/00-foundation/CONCEPT_CONSTITUTION.md` | DRAFT | CORE | Skeleton — founding principles |
...
Each section currently contains only `SECTION_README.md` (DRAFT shell). No detailed specifications yet.
...
| DEC-001 | `docs/13-decisions/ADR_INDEX.md` | DRAFT | Proposed ADR list |
